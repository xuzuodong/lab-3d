  ...
  paragraphs: [
...

    {
      ...
      talks: [
        '事不宜迟，我们先试着开始实验的第一步吧。',
        '酸溶液在本次实验中是必不可少的。',
        '所以我特意为你准备了两种酸性溶液供你选择哦，都已经放在试管的左侧了。',
        '试着去点击其中一种酸溶液吧！',
      ],
    },
...

    {
      ...
      choices: [
        ...
        { name: '我感觉有点问题..', replies: ['bingo~！回答正确！'] },
      ...
      choices: [
        {
          ...
          replies: [
            ...
            '对啦！正好我这里有一道小测试题，实验师试着去完成一下，让我见识下你的实力吧！',
          ],
        },
        {
          name: '还..没有听明白，能重复一遍吗?',
          replies: ['当然没问题！实验师请注意听讲哟。'],
        },
      ],
    },

    {
      ...
      talks: [
        ...
        '两种溶液的试剂瓶在试管的右侧，现在任意点击其中一种加入试管中吧！',
      ],
    },
...

    {
      ...
      talks: [
        ...
        '当然啦~！在某些酸碱物质的中和反应中，也不会出现太明显的现象变化，就像刚才实验师所观察到的。',
        '那么我们可以使用什么方法来帮助我们看到试管中的发生的反应呢？',
      ],
      choices: [
        {
          name: '酸碱指示剂',
          replies: ['酸碱指示剂，听起来好像行得通。', '那我们就把常见的酸碱指示剂拿出来试试吧！'],
        },
      ],
    },
...

    {
      id: '清空试管',
      talks: [
        '现在的试管中，我们的溶液已经进行过中和反应了，直接添加酸碱指示剂也不太合适呢。',
        '让我们先倒空试管，再进行实验吧！',
      ],
    },

    {
      id: '第一次自由实验导入',
      talks: [
        '实验师快看！前面的试管里面的溶液都已经空了呢。回到了最初始的状态。',
        '那么就让我们正式开始酸碱中和反应的实验吧！',
        '因为两种酸碱指示剂的实验现象各不相同，所以我们接下来会进行两轮实验——每一轮使用一种酸碱指示剂。',
        '那么，我们开始实验吧！注意：左侧的面板上也会提示你实验步骤的哦，请实验师留意！',
      ],
    },
    ...
    {
      id: '第二次自由实验导入',
      talks: ['试管清空完成！', '实验师，赶紧开始第二次自由实验吧！'],
    },

    {
      id: '第二次自由实验完成',
      talks: [
        '第二次自由实验顺利完成了！干的非常出色实验师！(๑•̀ㅂ•́)و✧',
        '这一次我们使用的是`酸碱指示剂`作为我们的酸碱指示剂。',
        '相信实验师已经观察到不同酸碱指示剂下的中和反应，都有哪些不一样的特征了呢。',
        '相信经过这两次次的酸碱中和实验，实验师已经对酸碱中和反应有一定了解了！',
