  ...
  paragraphs: [
    ...
    },
    {
      ...
      responses: [
        {
          name: '我准备好啦！',
          feedbacks: ['好咧！接下来又到了时间回溯的时间啦，实验师坐稳咯！', '嘿~！！时·间·倒·流！']
        }
      ]
    },
    {
      ...
      responses: [
        ...
        { name: '醋酸溶液', feedbacks: ['现在轮到你了！醋酸溶液！'] }
      ]
    },
    {
      id: '阶段三-滴入酸溶液',
      talks: ['`酸溶液`已经召唤出来咯！和刚才一样将它滴入到试管内吧！']
    },
    {
      id: '阶段三-选择酸碱指示剂',
      talks: [
    ...
    },
    {
      ...
      responses: [
        { name: '氢氧化钠溶液', feedbacks: ['出来吧！氢氧化钠！'] },
        { name: '小苏打溶液', feedbacks: ['身吧！小苏打溶液！  '] }
      ]
    },
    {
      id: '阶段三-滴入碱溶液',
      talks: [
        '碱溶液也成功召唤出来咯，这次选择的碱溶液是`碱溶液`呢。'
        // '接下来就试着将它滴入到试管内吧！',
    ...
    },
    {
      ...
      responses: [
        { name: '正有此意！', feedbacks: ['不愧是被选中的实验师，在实验的最后还是这么有精神~！'] },
        {
          name: '复盘..好麻烦呀',
          feedbacks: [
    ...
    },
    {
      ...
      responses: [
        { name: '使用酸碱指示剂！', feedbacks: ['Bingo！酸碱指示剂是我们判断酸碱度的好帮手~！'] },
        {
          name: '用心去感受！',
          feedbacks: [
    ...
    },
    {
      ...
      responses: [
        { name: '原来如此！我懂了。', feedbacks: ['太棒了！(๑•̀ㅂ•́)و✧，真不愧是最最最最最优秀的实验师！'] },
        { name: '可以再说一遍嘛？', feedbacks: ['当然没有问题！接下来我就再复盘一遍哦~。'] }
      ]
    },
    {
      id: '结束语1',
      ...
      responses: [
        { name: '总感觉很敷衍的庆祝呢...', feedbacks: ['Σ(⊙▽⊙！明明是发自真心地祝贺...'] },
        { name: '嘿嘿~谢谢你！', feedbacks: ['嘿嘿，都是实验师你自己努力的功劳啦！'] }
      ]
    },
    {
      id: '结束语2',
      ...
      responses: [{ name: '下次再见！', feedbacks: ['886!'] }]
    }
  ]
}
