...
export const materials = scene => {
  ...
  matTubeLiquid.diffuseColor = new BABYLON.Color3(0, 0, 1)
  ...
  return { matGround, matTube, matTubeLiquid, matGlass, matDropperLiquid, matPursolution, matPhesolution }
}
