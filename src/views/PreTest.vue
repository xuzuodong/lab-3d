  ...
  <q-dialog ref="dialog" @hide="onDialogHide" persistent>
    <q-card>
      ...
      <q-card-section>
        ...
        >
          <q-carousel-slide v-for="(item, index) in questionList" :key="item.id" :name="index">
...
export default {
  ...
  methods: {
    ...
    // setStorage(parm) {
    //   localStorage.setItem('begin', parm)
    //   localStorage.setItem('ntime', new Date().getTime())
    // },

    // getStorage() {
    //   let localDelay = {}
    //   localDelay.delay = localStorage.getItem('begin')
    //   localDelay.sec = localStorage.getItem('ntime')
    //   return localDelay
    // },
