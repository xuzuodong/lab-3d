<template>
  <div>
    <q-splitter v-model="splitter" disable>
      <template v-slot:before>
        <div class="column justify-center q-ma-md">
          <div class="col" style="width: 800px">
            <svg class="float-left" width="50" height="43">
              <rect width="15" height="43" />
            </svg>
            <div class="text-h5 q-my-sm float-left">知识图谱：实验知识网络</div>
            <q-btn class="float-right" flat round color="black">
              <svg
                class="icon"
      ...
      <template v-slot:after>
        <div class="row justify-around q-ma-md">
          <div class="col-10">
            ...
            <div class="text-h5 q-my-sm float-left">实验搜索</div>
          </div>
          <div class="col-10">
            <q-input bottom-slots v-model="text" label="" dense>
          ...
          <div class="col-5">
            <q-img :src="url" spinner-color="white" style="height: 174px; width: 133px; border-radius: 5px" />
          </div>
        ...
        <div class="row justify-around q-ma-md">
          <div class="col-10 q-my-lg">
            ...
            <div class="text-h5 q-my-sm float-left">智能推荐</div>
          </div>
          <div class="col-5">
            <q-img :src="url" spinner-color="white" style="height: 174px; width: 133px; border-radius: 5px" />
          </div>
...
export default {
  data() {
    return {
      text: '',
      splitter: 70,
      url: 'https://lab-3d-static.oss-cn-beijing.aliyuncs.com/ChemicalPropertiesOfDiluteSulfuricAcid/background.jpeg',
