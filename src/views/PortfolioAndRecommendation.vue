...
export default {
  ...
  created() {
    if (this.userInfo.id == 35) {
      ...
      this.classReview =
        '您所在的班级是【七年一班】，您的班级中在【中和反应】的平均得分在83分，您在【中和反应】实验中的最高分在78分，还未超过实验平均得分，建议再进行巩固与学习。'
    ...
    if (this.userInfo.id == 74) {
      ...
      this.classReview =
        '您所在的班级是【七年级五班】，您的班级中在【盐的溶解】的平均得分在83分，您在【盐的溶解】实验中的最高分在80分，还未超过实验平均得分，建议再进行巩固与学习。'
      this.experimentReview =
    ...
    if (this.userInfo.id == 95) {
      ...
      this.classReview =
        '您所在的班级是【七年级二班】，您的班级中在【物质的酸碱性】的平均得分在85分，您在【物质的酸碱性】实验中的最高分在81分，还未超过实验平均得分，建议再进行巩固与学习。'
      this.experimentReview =
