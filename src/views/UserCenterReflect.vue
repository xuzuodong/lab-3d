          ...
          <q-card style="border-radius: 30px; height: 300px">
            ...
            <q-card-section class="q-pa-none">
              <div class="column justify-center">
                <div class="col-10 text-center" style="height: 160px">
                  <q-img :src="url" style="height: 172.8px; width: 233.1px" />
                </div>
                <div class="col-1 text-center text-h6 q-mt-md">反思内容较少，仅展示示例词云</div>
              </div>
            </q-card-section>
          </q-card>
        </div>
